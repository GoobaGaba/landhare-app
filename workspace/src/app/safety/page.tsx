      ...
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <ul className="list-disc pl-6 my-3 space-y-2">
            ...
            <li><strong>Secure Payments:</strong> (Future Feature) All payments should ideally be processed through LandShare's secure platform once implemented. Avoid off-platform payment requests for initial bookings.</li>
          ...
          <ul className="list-disc pl-6 my-3 space-y-2">
            <li><strong>Screen Renters:</strong> Review renter profiles (when available) and communicate thoroughly.</li>
