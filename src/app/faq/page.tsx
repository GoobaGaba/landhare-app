...
// Original faqItems data - kept for reference, but not used in this simplified version
const faqItemsData = [
  {
    id: "general-1",
...
export default function FaqPage() {
  // Simplified renderAnswerWithLinks - still used for one static item
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      ...
      <Card className="max-w-3xl mx-auto shadow-lg">
        <CardHeader>
            <CardTitle>Our Mission (Static Section Title)</CardTitle>
        </CardHeader>
        <CardContent className="p-6 md:p-8 space-y-4">
          {/* Removed dynamic mapping of faqItems */}
          {/* Instead, hardcode a few simple FAQ items */}
          <div className="border-b pb-4 mb-4 last:border-b-0 last:pb-0 last:mb-0">
            <h3 className="text-lg font-semibold text-primary mb-2">
              What is LandShare? (Static)
            </h3>
            <p className="text-muted-foreground prose-sm dark:prose-invert max-w-none">
          ...
          <div className="border-b pb-4 mb-4 last:border-b-0 last:pb-0 last:mb-0">
           ...
           <div className="border-b pb-4 mb-4 last:border-b-0 last:pb-0 last:mb-0">
            <h3 className="text-lg font-semibold text-primary mb-2">
              What about fees? (Static)
            </h3>
            <div className="text-muted-foreground prose-sm dark:prose-invert max-w-none">
              {renderAnswerWithLinks("Please visit our [[Pricing Page]] for full details.")}
            </div>
          </div>
        </CardContent>
      </Card>
