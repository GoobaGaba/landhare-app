      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p className="text-lg text-muted-foreground mb-6">
            Welcome to LandShare Connect! These Terms of Service ("Terms") govern your access to and use of the LandShare Connect website, applications, and services (collectively, the "Services"). Please read these Terms carefully before using our Services.
          </p>
          ...
          <p>
            LandShare Connect provides an online platform that connects landowners ("Hosts") with individuals seeking to rent or lease land ("Renters") for various purposes, including but not limited to placing tiny homes, RVs, or manufactured homes.
          </p>
          ...
          <p>
            Hosts are solely responsible for their listings and compliance with all applicable laws. Renters are responsible for understanding the terms of any lease or rental agreement they enter into with a Host. LandShare Connect is not a party to any agreements entered into between Hosts and Renters.
          </p>
          
          <h2 className="text-xl font-semibold mt-6 mb-3">6. Fees and Payments</h2>
          <p>
            LandShare Connect may charge fees for certain services, such as contract initiation fees for free users or subscription fees for premium features. Closing fees may also apply to landowner payouts. All applicable fees will be disclosed to you prior to you incurring them. More details can be found on our <a href="/pricing" className="text-primary hover:underline">Pricing Page</a>.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-3">7. Intellectual Property</h2>
          <p>
            The Services and all content therein, including but not limited to text, graphics, logos, and software, are the property of LandShare Connect or its licensors and are protected by copyright and other intellectual property laws.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-3">8. Disclaimers and Limitation of Liability</h2>
          <p>
            The Services are provided "as is" and "as available" without any warranties of any kind. LandShare Connect will not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of the Services.
          </p>
          ...
          <p>
            LandShare Connect reserves the right to modify these Terms at any time. We will provide notice of any significant changes by posting the new Terms on our website or through other communication channels. Your continued use of the Services after such changes constitutes your acceptance of the new Terms.
          </p>
