...
const MOCK_FORMER_ADMIN_USER: User = { id: 'ZsAXo79Wh8XEiHFrcJwlJT2h89F3', name: 'Gabriel Leunda', email: 'admin@landshare.app', avatarUrl: 'https://placehold.co/100x100.png?text=GL', subscriptionStatus: 'free', createdAt: new Date('2023-01-01T10:00:00Z'), bio: 'A standard user account.', bookmarkedListingIds: ['listing-1-sunny-meadow', 'listing-3-desert-oasis'], walletBalance: 10000 };
const MOCK_GABE_ADMIN_USER: User = { id: 'AdminGNL6965', name: 'Gabeh', email: 'gabeh@landshare.app', avatarUrl: 'https://placehold.co/100x100.png?text=GNL', subscriptionStatus: 'premium', createdAt: new Date('2023-01-02T10:00:00Z'), bio: 'Platform Administrator.', bookmarkedListingIds: [], walletBalance: 500000 };
...
const MOCK_GOOGLE_USER_FOR_UI_TESTING: User = { id: 'mock-google-user-uid-67890', name: 'Mock Google User', email: 'mock.google.user@example.com', avatarUrl: 'https://placehold.co/100x100.png?text=GU', subscriptionStatus: 'free', createdAt: new Date('2023-04-01T10:00:00Z'), bio: 'I am a mock user signed in via Google for testing purposes.', bookmarkedListingIds: [], walletBalance: 10000 };
