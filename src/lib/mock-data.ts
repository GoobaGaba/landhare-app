...
const STANDARD_USER_STARTING_WALLET = 2500;
const ADMIN_USER_STARTING_WALLET = 10000;
...
const MOCK_USER_FOR_UI_TESTING: User = { id: 'mock-user-uid-12345', name: 'Mock UI Tester', email: 'mocktester@example.com', subscriptionStatus: 'standard', createdAt: new Date('2023-01-01T10:00:00Z'), bio: 'I am a standard mock user for testing purposes.', bookmarkedListingIds: ['listing-1-sunny-meadow', 'listing-3-desert-oasis'], walletBalance: STANDARD_USER_STARTING_WALLET };
const MOCK_GOOGLE_USER_FOR_UI_TESTING: User = { id: 'mock-google-user-uid-67890', name: 'Mock Google User', email: 'mock.google.user@example.com', subscriptionStatus: 'standard', createdAt: new Date('2023-04-01T10:00:00Z'), bio: 'I am a mock user signed in via Google for testing purposes.', bookmarkedListingIds: [], walletBalance: STANDARD_USER_STARTING_WALLET };

// --- INITIAL DEFAULT DATA ---
const getInitialData = (): MockDatabase => {
    const users = [MOCK_USER_FOR_UI_TESTING, { id: 'landowner-jane-doe', name: 'Jane Doe', email: 'jane@example.com', subscriptionStatus: 'standard', createdAt: new Date('2023-02-15T11:00:00Z'), bio: 'Experienced landowner with several plots available.', bookmarkedListingIds: [], walletBalance: STANDARD_USER_STARTING_WALLET }, { id: 'renter-john-smith', name: 'John Smith', email: 'john@example.com', subscriptionStatus: 'standard', createdAt: new Date('2023-03-20T12:00:00Z'), bio: 'Looking for a quiet place for my tiny home.', bookmarkedListingIds: ['listing-2-forest-retreat'], walletBalance: STANDARD_USER_STARTING_WALLET }, MOCK_GOOGLE_USER_FOR_UI_TESTING];
...
export const createUserProfile = async (userId: string, email: string, name?: string | null, avatarUrl?: string | null): Promise<User> => {
    const initialWalletBalance = ADMIN_UIDS.includes(userId) ? ADMIN_USER_STARTING_WALLET : STANDARD_USER_STARTING_WALLET;
